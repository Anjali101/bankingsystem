...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="main" style="background-color: #030B10;">
    ...
    <div class="subbody">
      ...
      <form class="row gy-2 gx-3 align-items-center" action="" style="margin-left: 38%; margin-right:25%;" method="post">
        ...
        <div class="mb-3 row" >
          <label for="amount" class="col-sm-2 col-form-label" id="amount">ENTER AMOUNT</label>
          <div class="col-sm-10">
          ...
          <button name="transfer" class="bt1" >Transfer</button>
        </div>
      <?php
      include 'connection.php';
